...
<div class="single-product-area">
    <div class="container">
        ...
        <!-- <div class="woocommerce-info">
            Have a coupon? <a class="showcoupon" data-toggle="collapse" href="#coupon-collapse-wrap"
                aria-expanded="false" aria-controls="coupon-collapse-wrap">Click here to enter your code</a>
        </div>
            ...
            <div id="customer_details" class="row">
                <div class="col-md-6">
                    ...
                    <p id="billing_company_field" class="form-row form-row-wide">
                        ...
                        <input type="text" value="" placeholder="" id="billing_company" name="billing_company"
                            class="input-text">
                    </p>
                    ...
                    <p id="billing_city_field" class="form-row form-row-wide address-field validate-required"
                        ...
                        <input type="text" value="" placeholder="Town / City" id="billing_city" name="billing_city"
                            class="input-text ">
                    </p>
                    ...
                    <p id="billing_state_field" class="form-row form-row-first address-field validate-state"
                        ...
                        <input type="text" id="billing_state" name="billing_state" placeholder="State / County" value=""
                            class="input-text ">
                    </p>
                ...
                <div class="col-md-6">
                    <h3 id="ship-to-different-address">
                        <label class="checkbox" for="ship-to-different-address-checkbox">Ship to a different
                            address?</label>
                    ...
                    <div class="shipping_address" style="display: block;">
                        ...
                        <p id="shipping_address_1_field" class="form-row form-row-wide address-field validate-required">
                            ...
                            <input type="text" value="" placeholder="Street address" id="shipping_address_1"
                        ...
                        <p id="shipping_state_field" class="form-row form-row-first address-field validate-state"
                            data-o_class="form-row form-row-first address-field validate-state">
                        ...
                        <p id="shipping_postcode_field"
                            ...
                            <input type="text" value="" placeholder="Postcode / Zip" id="shipping_postcode"
